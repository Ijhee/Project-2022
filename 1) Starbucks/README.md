...
- #### 3) Modeling
  ...
  > ##### ✓ ver2) </br>
  > 
  > Train Data : X -> 이디야, 올리브영, 다이소의 상점간 거리, 삼각형 정보 & Y -> EDA 데이터에서 스타벅스의 위도/경도 </br>
  > 
  > Test Data : 사용자가 입점하고 싶은 역의 다이소, 올리브영, 이디야의 좌표 및 추가한 변수들</br>
  > 
  > Model1 : 경도 학습 -> 경도 예측 / Model2: 위도 학습 -> 위도 예측</br>
  ...
  > ##### ✓ ver4) </br>
  > 
  > Train Data : X -> 이디야, 올리브영, 다이소의 위도 + 상점간 거리, 삼각형 정보 / 이디야, 올리브영, 다이소의 경도 + 상점간 거리, 삼각형 정보  & Y -> EDA 데이터에서 스타벅스의 위도/경도 </br>
  > 
  > Test Data : 사용자가 입점하고 싶은 역의 다이소, 올리브영, 이디야의 좌표 및 추가한 변수들</br>
  > 
  > Model1 : 경도 학습 -> 경도 예측 / Model2: 위도 학습 -> 위도 예측</br>
